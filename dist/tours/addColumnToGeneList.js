    ...
    return [
      ...
      <p>
        ...
        },
        {
            ...
            placement: 'centered',
            preAction: () => waitFor('.menu').then(() => wait(1000)).then(() => waitForSelector),
      ...
      To do so, we open the <i>'Cell Line Score (Aggregated)'</i> dialog`,
            ...
            postAction: () => {
                click('.lu-search .lu-search-group .lu-search-item:nth-child(2)');
                toggleClass('.lu-adder.once', 'once', false);
            }
        },
        {
            ...
            placement: 'centered',
            preAction: () => waitFor('.modal.in .modal-content').then(() => wait(250))
        },
        {
      ...
      <p>For the filter attribute we select <i>'Tumor Type'</i> &hellip;</p>`,
            placement: 'centered',
            postAction: () => {
                setValueAndTrigger('.modal-body form > .form-group:nth-child(1) .form-group:nth-child(1) div:nth-child(1) select', 'tumortype', 'change');
            }
        },
        {
            ...
            placement: 'centered',
            preAction: () => waitFor('.modal-body form > .form-group:nth-child(1) .form-group:nth-child(1) div:nth-child(2) .select2').then(() => wait(250)),
            postAction: () => {
                setValueAndTrigger('.modal-body form > .form-group:nth-child(1) .form-group:nth-child(1) div:nth-child(2) select', 'breast carcinoma', 'change');
            }
        },
        {
            ...
            postAction: () => {
                setValueAndTrigger('.modal-body form > .form-group:nth-child(2) select', 'copy_number-relativecopynumber', 'change');
            }
        },
        {
      ...
      <p>FYI: other types of aggregation are, for instance, <i>'Min'</i>, <i>'Max'</i>, <i>'Median'</i>, <i>'Count'</i>, and <i>'Boxplot'</i>.`,
            postAction: () => {
                setValueAndTrigger('.modal-body form > .form-group:nth-child(3) > select', 'avg', 'change');
            }
        },
        {
            selector: '.modal.in .modal-footer button[type=submit]',
        ...
        },
        {
            ...
            placement: 'centered',
            preAction: () => waitFor('.le header section[title^=avg]', 30000),
...
//# sourceMappingURL=addColumnToGeneList.js.map