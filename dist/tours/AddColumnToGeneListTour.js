...
export class AddColumnToGeneListTour {
    static createTour() {
        ...
        To do so, we open the <i>'Cell Line Score (Aggregated)'</i> dialog`,
            ...
            {
                selector: '.modal-body form > .mb-3:nth-child(1) .mb-3:nth-child(1) div:nth-child(1) select',
        ...
        <p>For the filter attribute we select <i>'Tumor Type'</i> &hellip;</p>`,
                placement: 'centered',
                postAction: () => {
                    TourUtils.setValueAndTrigger('.modal-body form > .mb-3:nth-child(1) .mb-3:nth-child(1) div:nth-child(1) select', 'tumortype', 'change');
                }
            },
            {
                selector: '.modal-body form > .mb-3:nth-child(1) .mb-3:nth-child(1) div:nth-child(2) .select2',
                html: `&hellip; and for the filter value we select <i>'breast carcinoma'</i>.`,
                placement: 'centered',
                preAction: () => TourUtils.waitFor('.modal-body form > .mb-3:nth-child(1) .mb-3:nth-child(1) div:nth-child(2) .select2').then(() => TourUtils.wait(250)),
                postAction: () => {
                    TourUtils.setValueAndTrigger('.modal-body form > .mb-3:nth-child(1) .mb-3:nth-child(1) div:nth-child(2) select', 'breast carcinoma', 'change');
                }
            },
            {
...
//# sourceMappingURL=AddColumnToGeneListTour.js.map