    ...
    static createTour() {
        ...
        <p>For the filter attribute we select <i>'Tumor Type'</i> &hellip;</p>`,
            ...
            },
            {
                ...
                placement: 'centered',
                preAction: () => TourUtils.waitFor('.show .modal-body form > .col-sm-12:nth-child(1) .row:nth-child(1) .row:nth-child(1) > div:nth-child(2) .select2').then(() => TourUtils.wait(250)),
                postAction: () => {
