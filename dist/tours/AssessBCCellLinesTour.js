    ...
    static createTour() {
        ...
        <p>They select ERBB2 in the list.</p>`,
            ...
            },
            {
                ...
                placement: 'centered',
                postAction: () => {
                    TourUtils.click('[data-testid="viewWrapper-1"] [data-testid=lu-adder-div] > .lu-search > .lu-search-list > :nth-child(2) > ul > :nth-child(1) > span');
                    TourUtils.toggleClass('.lu-adder.once', 'once', false);
                },
            },
            {
...
//# sourceMappingURL=AssessBCCellLinesTour.js.map