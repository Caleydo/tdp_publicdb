          ...
          one will be discarded.
            ...
            },
            {
                ...
                postAction: () => {
                    ...
                    return TourUtils.waitFor('.ordino-dataset.cellline-dataset').then(() => TourUtils.click('#ordino_dataset_tab > .ordino-scrollspy-nav > a:nth-child(1)'));
                },
                pageBreak: 'manual',
            },
            {
            ...
            },
            {
                ...
                postAction: () => {
                    ...
                    TourUtils.wait(1500).then(() => {
                        TourUtils.setValueAndTrigger('.show .modal-body form > .col-sm-12:nth-child(1) .row:nth-child(1) .row:nth-child(1) > div:nth-child(2) select', '0Qd2E6S4R9', 'change');
                    });
                },
            },
            {
...
//# sourceMappingURL=DrugTargetDiscoveryTour.js.map