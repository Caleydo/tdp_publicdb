import { waitFor, wait, waitForSelector, clickSelector, click } from 'tdp_core/src/tour/scripter';
export function create() {
    return [
      ...
      <p>The menu is divided into four sections ...</p>`,
            placement: 'centered',
            preAction: () => waitFor('.menu').then(() => wait(1000)),
        },
        {
        ...
        },
        {
            ...
            placement: 'centered',
            preAction: waitForSelector,
            postAction: () => click('label[for="lineUpDataToggle"]')
        },
        {
            ...
            placement: 'centered',
            preAction: () => waitFor('.startMenu.open .lineUpData').then(() => wait(250)),
            postAction: () => click('label[for="tdpSessionTemporaryDataToggle"]')
        },
        {
            ...
            placement: 'centered',
            preAction: () => waitFor('.startMenu.open .tdpSessionTemporaryData').then(() => wait(250)),
            postAction: () => click('label[for="tdpSessionPersistentDataToggle"]')
        },
        {
      ...
      This includes your analyses as well as analyses by other users that were shared with you.</p>`,
            placement: 'centered',
            preAction: () => waitFor('.startMenu.open .tdpSessionPersistentData').then(() => wait(250)),
            postAction: () => click('label[for="speciesSelectorToggle"]')
        },
        {
            selector: '.startMenu.open .speciesSelector',
            ...
            placement: 'centered',
            preAction: () => waitFor('.startMenu.open .speciesSelector').then(() => wait(250)),
        },
        {
