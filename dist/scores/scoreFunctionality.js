 ...
 */
function showSizeWarning(dialog, data, countHint = -1) {
...
function initializeScore(data, pluginDesc, aggregatedScoreFactory, frequencyScoreFactory) {
    const { primary, opposite } = selectDataSources(pluginDesc);
...
export function create(pluginDesc, extras, countHint) {
...
export function createAggregatedDepletionScore(data, pluginDesc) {
...
export function createAggregatedDepletionScoreDialog(pluginDesc, extras, countHint) {
    return createScoreDialog(pluginDesc, extras, FORM_AGGREGATED_SCORE_DEPLETION.slice(), countHint);
}
//# sourceMappingURL=scoreFunctionality.js.map