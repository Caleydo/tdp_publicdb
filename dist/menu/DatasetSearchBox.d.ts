...
export declare function DatasetSearchBox({ placeholder, dataSource, onOpen, onSaveAsNamedSet, params, tokenSeparators, testId: parentTestId }: IDatasetSearchBoxProps): JSX.Element;
export {};
