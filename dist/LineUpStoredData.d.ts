 ...
 */
export declare function loadEnsemblColumnDesc(idType: string): Promise<IAdditionalColumnDesc[]>;
/**
 ...
 */
export declare function loadEnsemblRows(idType: string, ids: string[]): Promise<IRow[]>;
