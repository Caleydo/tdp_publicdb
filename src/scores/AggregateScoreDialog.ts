...
export class AggregateScoreDialog {
  ...
  static create(pluginDesc: IPluginDesc, extras: any, countHint?: number) {
    return AggregateScoreDialog.createScoreDialog(pluginDesc, extras, FORM_AGGREGATED_SCORE.slice(), countHint);
  }

  static createAggregatedDepletionScoreDialog(pluginDesc: IPluginDesc, extras: any, countHint?: number) {
