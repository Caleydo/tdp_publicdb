 ...
 */
export const setNextActive = async (): Promise<'enable'> => 'enable';
...
export function openAddColumPanel() {
  ...
  (document.querySelector('.viewWrapper.t-focus .lu-search-input') as HTMLInputElement).onblur = (ev) => ev.preventDefault();
}
